...
app.use(controller.get('/prediction', function*() {
    this.set('Cache-Control', 'private');
    this.body = yield render('prediction');
}));


app.use(controller.get('/analysis', function*() {
    this.set('Cache-Control', 'private');
    this.body = yield render('analysis');
}));

app.use(controller.get('/downloads', function*() {
    this.set('Cache-Control', 'private');
    this.body = yield render('downloads');
}));

app.use(controller.get('/analysis_result', function*() {
    this.set('Cache-Control', 'private');
    this.body = yield render('analysis_result');
}));

app.use(controller.get('/prediction_result_1', function*() {
    this.set('Cache-Control', 'private');
    this.body = yield render('prediction_result_1');
}));

app.use(controller.get('/prediction_result_2', function*() {
    this.set('Cache-Control', 'private');
    this.body = yield render('prediction_result_2');
}));
